...
var _isOpen,
	...
	_bindEvents = function() {
		...
		//alert("bingo");
		framework.bind(window, 'resize', self);
			...
			if(_currZoomLevel <= self.currItem.fitRatio) {
				if( _options.modal ) {
					...
					if (!_options.closeOnScroll || _numAnimations || _isDragging) {
						...
						_closedByScroll = true;
						if(!turnOffThisMotherFuckingScrollButKeepTheModalOpen){
							self.close();
						}
					}
...
>>>>>>> 164f42dcef2d2247bcfcddeddf4915b103762911
/*!
	Autosize 3.0.15
	license: MIT
